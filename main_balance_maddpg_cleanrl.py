...
class QNetwork(nn.Module):
    def __init__(self, envs):
        ...
        n_all_states = np.array(envs.observation_space[0].shape).prod() * envs.n_agents
        n_all_actions = np.array(envs.action_space[0].shape).prod() * envs.n_agents
        self.fc1 = nn.Linear((n_all_states + n_all_actions), 256)
