...
if __name__ == '__main__':
    ...
    for agent_name in agent_names:
        ...
        critics[agent_name] = QCritic(envs, agent_name, args.n_hidden).to(device)
    ...
    for iteration in range(1, args.num_iterations + 1):
            ...
            while envs.agents:
                ...
                for agent_name in agent_names:
                    ...
                    with torch.no_grad():
                        ...
                        value = critics[agent_name].get_value(obs_agent.unsqueeze(0))
        ...
        for agent_name in agent_names:
            with torch.no_grad():
                ...
                next_value = critics[agent_name].get_value(agent_next_obs)
            ...
            for epoch in range(args.update_epochs):
                ...
                for start in range(0, args.batch_size, args.minibatch_size):
                    ...
                    _, newlogprob, entropy = actors[agent_name].get_action(
                        buffers[agent_name]["obs"][mb_inds], buffers[agent_name]["actions"][mb_inds])
                    newvalue = critics[agent_name].get_value(buffers[agent_name]["obs"][mb_inds]).squeeze(-1)
                    if args.clip_vloss:
